...
namespace Ireview.Infrastructure.Migrations
{
    ...
    [Migration("20230919090634_Adding relationships between stars and user")]
    partial class Addingrelationshipsbetweenstarsanduser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ireview.Core.Model.Stars", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ireview.Core.Model.Stars", b =>
                {
                    b.HasOne("Ireview.Core.Model.Article", "Article")
                        .WithMany("Stars")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Ireview.Infrastructure.Identity.Models.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
